      ...
      <Container>
        ...
        <OptionContainer>
          ...
          <CardContaienr>
            ...
            <ButtonContainer>
              <TouchableWithoutFeedback onPress={() => this.navigateTo('BuyTokens')}>
        ...
        <OptionContainer>
          <TextContainer>
            ...
            <SubText>You can withdraw your cash winnings. Or buy more play tockens for cash.  !</SubText>
          </TextContainer>
          <CardContaienr>
            <Card>
              <PointContainer>
                <Image style={{marginRight: 4}} source={require('icons/64.png')}/>
                <Points>15</Points>
                <PointsText>Tockens</PointsText>
              </PointContainer>
            </Card>
        ...
        <CardMD>
        <LinearGradient style={{borderRadius: 5}} colors={['#D8341D', '#FE5B3B']}  start={{x: 0.0, y: 0.25}} end={{x: 0.5, y: 1.0}}>

        <StatusContainer>
          <StatusWrapper>
          <Image style={{marginRight: 4}} source={require('icons/Vector.png')}/>
            <View>
            ...
            <Text2>
            These 2 lines here explain how the status works and what it helps to achieve.
            </Text2>
          <ButtonText>
          Upgrade now!
          </ButtonText>
