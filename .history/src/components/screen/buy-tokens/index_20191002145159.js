  ...
  state = { text: '' };
    ...
    return (
        <View style={{backgroundColor: '#E5E5E5', flex: 1}}>
            <Header screenTitle="Buy tockens" componentId={componentId} back={back}/> 
            <Container style={{backgroundColor: '#E5E5E5', flex: 1}}>
                ...
                <TextInput
                placeholder="e.g., 85"
        style={{height: 40, borderBottomColor: 'gray', borderBottomWidth: 1, textAlign: 'center', marginBottom: 10}}
        ...
        value={this.state.text} />
                ...
                <View style={{backgroundColor: '#FBDC42', borderRadius: 25, width: 200, height: 50, justifyContent: 'center', alignItems: 'center', alignSelf: 'center', marginTop: 12}}>
                        <Text style={{color: '#333333', fontSize: 16, fontWeight: 'bold'}}>Play now</Text>
                    </View>
            </Container>
        </View>
    )
